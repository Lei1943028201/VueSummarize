...
const localUrl = {
    ...
    AJAXResponseStateCodeData: "/api/AJAXResponseStateCodeData"
}
const serverUrl = {
...
export function reqAJAXResponseStateCodeData() { // 返回是promise对象
    return axios.get(url.AJAXResponseStateCodeData)
}